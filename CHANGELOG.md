...
- pinned the hosted PR-size caller to the reviewed advisory governance
  revision and removed its unused pull-request permission; GuardGuide remains
  free of a local size gate
