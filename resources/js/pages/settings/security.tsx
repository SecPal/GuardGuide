...
export default function Security(props: Props) {
    ...
    return (
        <>
            <Head title={i18n._('settings.security.metaTitle')} />

            <h1 className="sr-only">{i18n._('settings.security.metaTitle')}</h1>

            <div className="space-y-6">
                <Heading
                    variant="small"
                    title={i18n._('settings.security.updateTitle')}
                    description={i18n._('settings.security.updateDescription')}
                />
